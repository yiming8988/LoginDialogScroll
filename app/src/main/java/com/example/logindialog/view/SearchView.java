...
public class SearchView extends RelativeLayout {
	...
	private void init(Context context) {
		...
		SearchView.this.scrollTo(0, mScreenHeigh);
	...
	public void show(){
		if(!isShow && !isMoving){
			SearchView.this.startMoveAnim(viewHeight,   -viewHeight, mDuration);
			isShow = true;
			Log.d("isShow", "true");
			changed();
		}
	...
	public void dismiss(){
		if(isShow && !isMoving){
			SearchView.this.startMoveAnim(0, viewHeight, mDuration);
			isShow = false;
			Log.d("isShow", "false");
			changed();
		}
